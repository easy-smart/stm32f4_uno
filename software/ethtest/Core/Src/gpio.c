...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, J107_8_Pin|F_CS_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : PAPin PAPin PA10 PAPin */
  GPIO_InitStruct.Pin = J108_6_Pin|J110_4_Pin|GPIO_PIN_10|J111_5_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  /*Configure GPIO pins : PAPin PAPin */
  GPIO_InitStruct.Pin = J107_8_Pin|F_CS_Pin;
